...
export function MultiScannerDashboard({stocks,status,newsArticles,ukTime,etTime}:Props){
  ...
  return <div className="ms-shell">
    ...
    <div className="ms-grid">
      ...
      <section className="ms-panel ms-gap"><PanelHead title="GAP UP / RUNNERS" icon={<TrendingUp size={13}/>} count={gaps.length}/><MiniList items={gaps} onSelect={setSelected}/></section>
    </div>
